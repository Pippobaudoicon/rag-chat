...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden text-base md:text-sm",
...
function useLazyPlugins(): StreamdownPlugins {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      if (!cancelled) setPlugins({ cjk, code, math, mermaid });
    });
