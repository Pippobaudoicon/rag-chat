...
export function ChatInterface({
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      {/* Input area */}
      <div className="border-t border-border/50 bg-linear-to-b from-background to-muted/20 backdrop-blur-sm px-4 py-4 pb-[max(0.75rem,calc(env(safe-area-inset-bottom)*0.5))]">
